    ...
    public partial class V1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieSaloon", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieSaloon_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieSaloon_Saloons_SaloonId",
                        column: x => x.SaloonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSaloon_MovieId",
                table: "MovieSaloon",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieSaloon_SaloonId",
                table: "MovieSaloon",
                column: "SaloonId");
        }
